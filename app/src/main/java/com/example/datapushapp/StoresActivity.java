...
public class StoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = rootNode.getReference("Stores");

        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(StoresActivity.this,StoresViewActivity.class);
                i.putExtra("pass","Stores");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference2.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Storesuploadmodel addnewUser = new Storesuploadmodel(aname.getText().toString(),descri.getText().toString(),pincode.getText().toString(),url);
...
//                            databaseReference.child(ImageUploadId).setValue(imageUploadInfo);
            ...
            Toast.makeText(StoresActivity.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
