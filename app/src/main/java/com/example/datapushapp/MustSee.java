...
public class MustSee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = rootNode.getReference("MustSee");
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MustSee.this,ArtViewActivity.class);
                i.putExtra("pass","MustSee");
...
//                            databaseReference.child(ImageUploadId).setValue(imageUploadInfo);
            ...
            Toast.makeText(MustSee.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
